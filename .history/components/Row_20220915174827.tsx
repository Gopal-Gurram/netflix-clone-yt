  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      ...
      <div className="relative group md:-ml-2">
        <ChevronLeftIcon className="absolute top-0 z-40 m-auto transition opacity-0 cursor-pointer botton-0 left-2 h-9 w-9 hover:scale-125 group-hover:opacity-100" onClick={}/>
        <div
          ref={useRef}
