  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      ...
      <div className="relative group md:-ml-2">
        <ChevronLeftIcon className="absolute z-40 p-0 m-auto transition border-0 cursor-pointer topacity-0 left-2 h-9 w-9 hover:scale-125 group-hover:opacity-100" />
